...
8. **股票代码格式**：`600519.SH`(沪), `000001.SZ`(深), `300750.SZ`(创), `688xxx.SH`(科创), `8xxxxx.BJ`(北交所), `xxBxxx.OF`(养老金基金)
9. **基金字段**：`vnetasset_total` 不可用（错误码 -40522007），应使用 `netasset_total` 获取基金资产净值
